...
# Must match exp_ablation.sh's single_rand config exactly (distortion_progressive, not
# plain distortion) for this sanity check to be a valid gs_mesh vs LMGModel comparison.
